...
public class RabbitMQOptions {
	...
	/**
	 * The default port = {@code - 1} - {@code 5671} for SSL otherwise
	 * {@code 5672}
	 */
	...
	/**
	 * Set the TCP connection timeout, in milliseconds, {@code zero} for
	 * infinite).
	...
	/**
	 * Set the initially requested heartbeat interval, in seconds, {@code zero}
	 * for none.
	...
	/**
	 * Set the initially requested maximum channel number, {@code zero} for
	 * unlimited.
	...
	/**
	 * Set how long in milliseconds will automatic recovery wait before
	 * attempting to reconnect, default is {@code 5000}
	 * @param networkRecoveryInterval the connection recovery interval
	 * @return a reference to this, so the API can be used fluently
	 */
	public RabbitMQOptions setNetworkRecoveryInterval(
	...
	/**
	 * @return {@code true} if automatic connection recovery is enabled,
	 ...
	 * @param automaticRecoveryEnabled if {@code true}, enables connection
	 *            recovery
	 * @return a reference to this, so the API can be used fluently
	 */
	public RabbitMQOptions setAutomaticRecoveryEnabled(
	...
	/**
	 * @return wether to include properties when a broker message is passed on
	 *         the event bus
	 */
	...
	/**
	 * Set wether to include properties when a broker message is passed on the
	 * event bus
	...
	/**
	 * @return the SSLContext configured for this client
	 */
	...
	/**
	 * Set the SSLContext to be used when connecting to RabbitMQ
